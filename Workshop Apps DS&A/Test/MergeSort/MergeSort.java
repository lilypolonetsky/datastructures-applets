...
public void arrowText(Graphics g, Color c, String s,
   ...
   public void draw(Graphics g)      // draw the bargraph
      ...
      if(aSize==12)                  // if few bars,
         ...
         drawMode = 2;  //**********NEW************
//      drawMode = 1;                 // for next time  //************Deleted*********
      }  // end draw()
   //-----------------------------------------------------------
...
public class MergeSort extends java.applet.Applet
   ...
   {
   private volatile Thread runner;  //**************************ADDED VOLITILE***********
   ...
   public void start()
      {
//      thePersonGroup.setDrawMode(2);  //***********NO HELP**************
   ...
   public void run()
      {
      Thread thisThread = Thread.currentThread();   //*********************NEW******************
//      while(true)                                 //***************DELETED********************
      while(runner==thisThread)                     //*****************NEW***************
         {
