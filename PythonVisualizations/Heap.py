...
class Heap(object):
    ...
    def insert(self, k, d):
        ...
        try: 
            print("this is Elems before insert",self.__nElems)
            ...
            #print("this is array ", self.__arr)
            ...
            if len(self.__ovals) != 0 and self.__arr[self.__nElems-1]==None:
                
                #print("this is list oval at last positions: ", self.__ovals[self.__nElems])
        
                print("this node should be replacing the None")
            ...
            print("this is nElems after insert", self.__nElems)
            print('this list oval', self.__oval)
    ...
    def swapRoot(self):
        ...
        print("this is oval after swapping last node with root :", self.__ovals)     
        ...
        print("this is self.oval after NONE", self.__ovals)
        print("this is nElemns in swapRoot", self.__nElems)
        root.update()    
